...
class HTTPInvalidContentFormatException(WebapiHTTPException):
    pass

class HTTPInvalidFileFormatException(WebapiHTTPException):
    pass

class HTTPDataEmptyException(WebapiHTTPException):
    pass